     ...
     public  void ViewByProjectId()
        {
            ...
            Project project = projectObj.ViewByID(projetById);
            ...
            if (project != null)
            {
                ...
                System.Console.WriteLine($"ProjectId:{project.ProjectId}, ProjectName: {project.ProjectName}, Startsate: {project.StartDate}, EndDate:{project.EndDate}");
                Console.ResetColor();
            }
            else
            {
